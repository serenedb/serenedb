...
In contrast, `STRUCT`s must have string keys, but each value may have a different type. See the [data types overview](../../sql/data_types/index.md) for a comparison between nested data types.
