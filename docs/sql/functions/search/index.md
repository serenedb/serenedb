...
| [Tokenizers](./tokenizers.md) | Every dictionary template as a scalar function — `split_text`, `stem_words`, `generate_ngrams`, `split_text_csv` and the others — for ad hoc analysis without a dictionary |
