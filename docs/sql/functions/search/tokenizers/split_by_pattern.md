...
<SqlLogicTest id="sql/functions/search/tokenizers/split_by_pattern/example_004" />

## See also

- [`split_text_csv`](./split_text_csv.md) / [`split_by_delimiters`](./split_by_delimiters.md) — split on literal characters
- [`split_text`](./split_text.md) — Unicode word-boundary splitting
