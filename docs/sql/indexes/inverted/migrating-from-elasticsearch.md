...
| [`more_like_this`](https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-mlt-query.html) | ⚠️ | No direct function; use the [`minhash`](../../statements/create_text_search_dictionary/minhash/index.md) scalar function or [vector](./vector-search.md) similarity |
...
| Elasticsearch | SereneDB | Notes |
|---|:---:|---|
| [Tokenizers](https://www.elastic.co/guide/en/elasticsearch/reference/current/analysis-tokenizers.html) | ✅ | [`split_text`](../../statements/create_text_search_dictionary/text.md), [`generate_ngrams`](../../statements/create_text_search_dictionary/ngram.md), [`split_text_csv`](../../statements/create_text_search_dictionary/csv.md), [`split_text_icu`](../../statements/create_text_search_dictionary/icu_text.md), … [templates](./text-analysis.md) |
| [Token filters](https://www.elastic.co/guide/en/elasticsearch/reference/current/analysis-tokenfilters.html) (lowercase / stemming / stopwords) | ✅ | [`split_text`](../../statements/create_text_search_dictionary/text.md) template options + [`stem_words`](../../statements/create_text_search_dictionary/stem.md) / [`remove_stopwords`](../../statements/create_text_search_dictionary/stopwords.md) templates |
...
| [n-gram](https://www.elastic.co/guide/en/elasticsearch/reference/current/analysis-ngram-tokenizer.html) / [edge n-gram](https://www.elastic.co/guide/en/elasticsearch/reference/current/analysis-edgengram-tokenizer.html) | ✅ | [`generate_ngrams`](../../statements/create_text_search_dictionary/ngram.md) (`mode = 'only_prefix'` for edge n-grams), [`generate_sparse_ngrams`](../../statements/create_text_search_dictionary/sparse-ngram.md) |
| [Shingles](https://www.elastic.co/guide/en/elasticsearch/reference/current/analysis-shingle-tokenfilter.html) | ✅ | [`generate_shingles`](../../statements/create_text_search_dictionary/shingle.md) wraps another template and emits word n-grams |
| [Synonyms](https://www.elastic.co/guide/en/elasticsearch/reference/current/analysis-synonym-tokenfilter.html) | ✅ | [`expand_solr_synonyms`](../../statements/create_text_search_dictionary/solr-synonyms.md), [`expand_wordnet_synonyms`](../../statements/create_text_search_dictionary/wordnet-synonyms.md) |
