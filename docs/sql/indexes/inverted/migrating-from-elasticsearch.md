...
| Elasticsearch | SereneDB | Notes |
|---|:---:|---|
| [Tokenizers](https://www.elastic.co/guide/en/elasticsearch/reference/current/analysis-tokenizers.html) | ✅ | [`split_text`](../../statements/create_text_search_dictionary/text.md), [`generate_ngrams`](../../statements/create_text_search_dictionary/ngram.md), [`split_csv`](../../statements/create_text_search_dictionary/csv.md), [`split_text_icu`](../../statements/create_text_search_dictionary/icu_text.md), … [templates](./text-analysis.md) |
