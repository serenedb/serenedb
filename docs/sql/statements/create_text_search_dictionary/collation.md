...
- [`collate_tokens()`](../../functions/search/tokenizers.md#collate_tokens) — the template as a function, applied to a value or a list in any query
