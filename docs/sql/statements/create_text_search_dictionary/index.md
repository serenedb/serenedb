...
- **Wrappers.** [`generate_shingles`](./shingle.md) and [`generate_wildcard_ngrams`](./wildcard.md) analyze the tokens of a nested analyzer, so they take a chain as their first argument: `generate_shingles(split_text_csv(' ') | normalize_tokens(case := 'lower'), 2, 3)`.
...
| Template | Description |
|---|---|
| [`split_text_csv`](./csv.md) | Split on a single delimiter |
