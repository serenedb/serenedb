function help() {
  ...
  echo "  -q/--source-dir         SereneDB source dir (default: .)"
  echo "  -B/--bin-dir            SereneDB binary dir (default: ./build)"
  echo "  -O/--ongoing-ports      Ongoing ports       (default: false)"
  echo "  --rr                    Run serened with rr (true|false       default: false)"
  ...
  echo "  -E/--enable-backup   Disable backup  (default default: true)"
  echo ""
  echo "EXAMPLES:"
  echo "  $0"
