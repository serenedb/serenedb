# python script for loading some sample data into SereneDB database.
# Dependencies
#   * python-serene driver [https://github.com/Joowani/python-serene]
...
def main():
  ...
  # Initialize the client for SereneDB.
  client = SereneClient(hosts=host)
