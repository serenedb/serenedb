...
TEST(boolean_weight_test, create) {
  // not a member
  {
...

    {
      ...
      fst::fsa::BooleanWeight read_weight;
      read_weight.Read(ss);
...
TEST(boolean_weight_test, divide) {
  ...
  ASSERT_EQ(BooleanWeight::NoWeight(),
            Divide(BooleanWeight::One(), BooleanWeight::Zero(), DIVIDE_RIGHT));
  ASSERT_EQ(BooleanWeight::NoWeight(),
            Divide(BooleanWeight::One(), BooleanWeight::Zero(), DIVIDE_ANY));
  ASSERT_EQ(BooleanWeight::NoWeight(),
            Divide(BooleanWeight::Zero(), BooleanWeight::One(), DIVIDE_LEFT));
  ASSERT_EQ(BooleanWeight::NoWeight(),
            Divide(BooleanWeight::Zero(), BooleanWeight::One(), DIVIDE_RIGHT));
  ASSERT_EQ(BooleanWeight::NoWeight(),
            Divide(BooleanWeight::Zero(), BooleanWeight::One(), DIVIDE_ANY));
  ASSERT_EQ(BooleanWeight::NoWeight(),
            Divide(BooleanWeight::Zero(), BooleanWeight::Zero(), DIVIDE_LEFT));
  ASSERT_EQ(BooleanWeight::NoWeight(),
            Divide(BooleanWeight::Zero(), BooleanWeight::Zero(), DIVIDE_RIGHT));
  ASSERT_EQ(BooleanWeight::NoWeight(),
            Divide(BooleanWeight::Zero(), BooleanWeight::Zero(), DIVIDE_ANY));
  ASSERT_EQ(BooleanWeight::NoWeight(),
            Divide(BooleanWeight::One(), BooleanWeight::One(), DIVIDE_LEFT));
  ASSERT_EQ(BooleanWeight::NoWeight(),
            Divide(BooleanWeight::One(), BooleanWeight::One(), DIVIDE_RIGHT));
  ASSERT_EQ(BooleanWeight::NoWeight(),
...
TEST(boolean_weight_test, times) {
  ...
  ASSERT_EQ(BooleanWeight(false, 0),
            Times(BooleanWeight(false, 31), BooleanWeight(true, 32)));
  ASSERT_EQ(BooleanWeight(true, 11),
            Times(BooleanWeight(true, 31), BooleanWeight(true, 11)));
  ASSERT_EQ(BooleanWeight(false, 11),
            Times(BooleanWeight(false, 31), BooleanWeight(false, 11)));
  ASSERT_EQ(BooleanWeight::One(),
            Times(BooleanWeight::One(), BooleanWeight::One()));
  ASSERT_EQ(BooleanWeight::Zero(),
            Times(BooleanWeight::One(), BooleanWeight::Zero()));
  ASSERT_EQ(BooleanWeight::One(),
            Times(BooleanWeight::One(), BooleanWeight::NoWeight()));
  ASSERT_EQ(BooleanWeight::One(),
            Times(BooleanWeight::NoWeight(), BooleanWeight::NoWeight()));
  ASSERT_EQ(BooleanWeight::One(),
            Times(BooleanWeight::NoWeight(), BooleanWeight::One()));
}
...
TEST(boolean_weight_test, plus) {
  ...
  ASSERT_EQ(BooleanWeight(true, 63),
            Plus(BooleanWeight(false, 31), BooleanWeight(true, 32)));
  ASSERT_EQ(BooleanWeight(true, 31),
            Plus(BooleanWeight(true, 31), BooleanWeight(true, 11)));
  ASSERT_EQ(BooleanWeight(false, 31),
            Plus(BooleanWeight(false, 31), BooleanWeight(false, 11)));
  ASSERT_EQ(BooleanWeight::One(),
            Plus(BooleanWeight::One(), BooleanWeight::One()));
  ASSERT_EQ(BooleanWeight::One(),
            Plus(BooleanWeight::One(), BooleanWeight::Zero()));
  ASSERT_EQ(BooleanWeight::One(),
            Plus(BooleanWeight::One(), BooleanWeight::NoWeight()));
  ASSERT_EQ(BooleanWeight::One(),
            Plus(BooleanWeight::NoWeight(), BooleanWeight::NoWeight()));
  ASSERT_EQ(BooleanWeight::One(),
            Plus(BooleanWeight::NoWeight(), BooleanWeight::One()));
}

class AutomatonTestBase : public TestBase {
 protected:
  static void AssertProperties(const irs::automaton& a) {
    ...
    ASSERT_EQ(kExpectedProperties, a.Properties(kExpectedProperties, true));
  }

  static void AssertArc(const irs::automaton::Arc& actual_arc,
  ...
  static void AssertState(
    ...
    for (auto& expected_arc : expected_arcs) {
      AssertArc(*actual_arc, expected_arc.first, expected_arc.second);
      ++actual_arc;
    }
  };

  static void AssertAutomaton(
    ...
    for (auto& expected_arcs : expected_automaton) {
      AssertState(a, state, expected_arcs);
      ++state;
    }
  }
};

class Utf8TransitionsBuilderTest : public AutomatonTestBase {};

TEST_F(Utf8TransitionsBuilderTest, no_arcs) {
  irs::Utf8TransitionsBuilder builder;
  ...
  // default transition
  {
    ...
    // arcs from start state
    {
      ...
      AssertArc(actual_arcs.arcs[0], irs::RangeLabel::From(0, 127), finish);
      AssertArc(actual_arcs.arcs[1], irs::RangeLabel::From(194, 223),
                intermediate0);
      AssertArc(actual_arcs.arcs[2], irs::RangeLabel::From(224, 239),
                intermediate1);
      AssertArc(actual_arcs.arcs[3], irs::RangeLabel::From(240, 244),
                intermediate2);
    }
    ...
    // arcs from 'intermediate0'
    {
      ...
      AssertArc(actual_arcs.arcs[0], irs::RangeLabel::From(128, 191), finish);
    }
    ...
    // arcs from 'intermediate1'
    {
      ...
      ASSERT_EQ(1, actual_arcs.narcs);
      AssertArc(actual_arcs.arcs[0], irs::RangeLabel::From(128, 191),
                intermediate0);
    }
...
TEST_F(Utf8TransitionsBuilderTest, empty_arc) {
  irs::Utf8TransitionsBuilder builder;
  ...
  // default transition
  {
    ...
    // arcs from 'intermediate0'
    {
      ...
      a.InitArcIterator(intermediate0, &actual_arcs);
      ASSERT_EQ(1, actual_arcs.narcs);
      AssertArc(actual_arcs.arcs[0], irs::kRhoLabel, finish);
    }
    ...
    // arcs from 'intermediate1'
    {
      ...
      a.InitArcIterator(intermediate1, &actual_arcs);
      ASSERT_EQ(1, actual_arcs.narcs);
      AssertArc(actual_arcs.arcs[0], irs::kRhoLabel, intermediate0);
    }
    ...
    // arcs from 'intermediate2'
    {
      ...
      a.InitArcIterator(intermediate2, &actual_arcs);
      ASSERT_EQ(1, actual_arcs.narcs);
      AssertArc(actual_arcs.arcs[0], irs::kRhoLabel, intermediate1);
    }
...
TEST_F(Utf8TransitionsBuilderTest, single_byte_sequence) {
  irs::Utf8TransitionsBuilder builder;
  ...
  // no default transition
  {
    ...
    // arcs from start state
    {
      ...
      for (auto& arc : arcs) {
        ...
        AssertArc(*actual_arc, irs::RangeLabel::From(arc.first[0]), arc.second);
        ++actual_arc;
      }
  ...
  // default transition
  {
    ...
    // arcs from start state
    {
      ...
      while (expected_arc != arcs.end()) {
        ...
        AssertArc(*actual_arc, irs::RangeLabel::From(expected_arc->first[0]),
                  actual_arc->nextstate);
      ...
      ASSERT_LT(min, 128);
      AssertArc(*actual_arc, irs::RangeLabel::From(min, 127), finish1);
      ++actual_arc;
      ASSERT_NE(actual_arc, actual_arcs.arcs + actual_arcs.narcs);
      AssertArc(*actual_arc, irs::RangeLabel::From(194, 223), intermediate0);
      ++actual_arc;
      ASSERT_NE(actual_arc, actual_arcs.arcs + actual_arcs.narcs);
      AssertArc(*actual_arc, irs::RangeLabel::From(224, 239), intermediate1);
      ++actual_arc;
      ASSERT_NE(actual_arc, actual_arcs.arcs + actual_arcs.narcs);
      AssertArc(*actual_arc, irs::RangeLabel::From(240, 244), intermediate2);
      ++actual_arc;
      ASSERT_EQ(actual_arc, actual_arcs.arcs + actual_arcs.narcs);
    }
    ...
    // arcs from 'intermediate0'
    {
      ...
      a.InitArcIterator(intermediate0, &actual_arcs);
      ASSERT_EQ(1, actual_arcs.narcs);
      AssertArc(actual_arcs.arcs[0], irs::RangeLabel::From(128, 191), finish1);
    }
...
TEST_F(Utf8TransitionsBuilderTest, multi_byte_sequence) {
  irs::Utf8TransitionsBuilder builder;

  {
    ...
    AssertAutomaton(a, expected_automaton);
  }
}

TEST_F(Utf8TransitionsBuilderTest, multi_byte_sequence_default_state) {
  irs::Utf8TransitionsBuilder builder;
...
class Utf8EmplaceArcTest : public AutomatonTestBase {};
...
TEST_F(utf8_emplace_arc_test, emplace_arc_no_default_arc) {
  // 1-byte sequence
  {
    ...
    irs::Utf8EmplaceArc(a, start, fst::kNoStateId,
                        irs::ViewCast<irs::byte_type>(label), finish);

    const std::vector<std::vector<
      std::pair<irs::automaton::Arc::Label, irs::automaton::StateId>>>
      expected_automaton{{{irs::RangeLabel{0x61, 0x61}, 1}}, {}};
  ...
  // 2-byte sequence
  {
    ...
    const std::vector<std::vector<
      std::pair<irs::automaton::Arc::Label, irs::automaton::StateId>>>
      expected_automaton{
        {{irs::RangeLabel{0xD0, 0xD0}, 2}},
        {},
        {{irs::RangeLabel{0xBF, 0xBF}, 1}},
      };
  ...
  // 3-byte sequence
  {
    ...
    const std::vector<std::vector<
      std::pair<irs::automaton::Arc::Label, irs::automaton::StateId>>>
      expected_automaton{
        {{irs::RangeLabel{0xE2, 0xE2}, 2}},
        {},
        {{irs::RangeLabel{0x9E, 0x9E}, 3}},
        {{irs::RangeLabel{0x96, 0x96}, 1}},
      };
  ...
  // 4-byte sequence
  {
    ...
    const std::vector<std::vector<
      std::pair<irs::automaton::Arc::Label, irs::automaton::StateId>>>
      expected_automaton{
        {{irs::RangeLabel{0xF0, 0xF0}, 2}}, {},
        {{irs::RangeLabel{0x9F, 0x9F}, 3}}, {{irs::RangeLabel{0x98, 0x98}, 4}},
        {{irs::RangeLabel{0x81, 0x81}, 1}},
      };
...
TEST_F(utf8_emplace_arc_test, emplace_arc_default_arc) {
  // 1-byte sequence
  {
    ...
    const std::string_view label = "a";
    irs::Utf8EmplaceArc(a, start, def, irs::ViewCast<irs::byte_type>(label),
                        finish);
    ...
    // arcs from start state
    {
      ...
      auto* actual_arc = actual_arcs.arcs;
      assert_arc(*actual_arc, irs::RangeLabel{0, 'a' - 1}, def);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{'a', 'a'}, finish);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{'a' + 1, 127}, def);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{194, 223}, intermediate0);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{224, 239}, intermediate1);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{240, 255}, intermediate2);
      ++actual_arc;
      ASSERT_EQ(actual_arc, actual_arcs.arcs + actual_arcs.narcs);
    }
    ...
    // arcs from 'intermediate0'
    {
      ...
      a.InitArcIterator(intermediate0, &actual_arcs);
      ASSERT_EQ(1, actual_arcs.narcs);
      assert_arc(actual_arcs.arcs[0], irs::RangeLabel{128, 191}, def);
    }
    ...
    // arcs from 'intermediate1'
    {
      ...
      a.InitArcIterator(intermediate1, &actual_arcs);
      ASSERT_EQ(1, actual_arcs.narcs);
      assert_arc(actual_arcs.arcs[0], irs::RangeLabel{128, 191}, intermediate0);
    }
    ...
    // arcs from 'intermediate2'
    {
      ...
      a.InitArcIterator(intermediate2, &actual_arcs);
      ASSERT_EQ(1, actual_arcs.narcs);
      assert_arc(actual_arcs.arcs[0], irs::RangeLabel{128, 191}, intermediate1);
    }
  ...
  // 2-byte sequence
  {
    ...
    // arcs from start state
    {
      ...
      ASSERT_EQ(6, actual_arcs.narcs);
      auto* actual_arc = actual_arcs.arcs;
      assert_arc(*actual_arc, irs::RangeLabel{0, 127}, def);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{194, 207}, intermediate0);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{208, 208}, intermediate2 + 1);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{209, 223}, intermediate0);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{224, 239}, intermediate1);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{240, 255}, intermediate2);
    ...
    // arcs from 'intermediate2+1'
    {
      ...
      assert_arc(actual_arcs.arcs[0], irs::RangeLabel{128, 190}, def);
      assert_arc(actual_arcs.arcs[1], irs::RangeLabel{191, 191}, finish);
    }
  ...
  // 3-byte sequence
  {
    ...
    // arcs from start state
    {
      ...
      assert_arc(*actual_arc, irs::RangeLabel{194, 223}, intermediate0);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{224, 225}, intermediate1);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{226, 226}, intermediate2 + 1);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{227, 239}, intermediate1);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{240, 255}, intermediate2);
      ++actual_arc;
      ASSERT_EQ(actual_arc, actual_arcs.arcs + actual_arcs.narcs);
    ...
    // arcs from 'intermediate2+1'
    {
      ...
      assert_arc(actual_arcs.arcs[0], irs::RangeLabel{128, 157}, intermediate0);
      assert_arc(actual_arcs.arcs[1], irs::RangeLabel{158, 158},
                 intermediate2 + 2);
      assert_arc(actual_arcs.arcs[2], irs::RangeLabel{159, 191}, intermediate0);
    }
    ...
    // arcs from 'intermediate2+2'
    {
      ...
      ASSERT_EQ(3, actual_arcs.narcs);
      assert_arc(actual_arcs.arcs[0], irs::RangeLabel{128, 149}, def);
      assert_arc(actual_arcs.arcs[1], irs::RangeLabel{150, 150}, finish);
      assert_arc(actual_arcs.arcs[2], irs::RangeLabel{151, 191}, def);
    }
  ...
  // 4-byte sequence
  {
    ...
    // arcs from start state
    {
      ...
      assert_arc(*actual_arc, irs::RangeLabel{224, 239}, intermediate1);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{240, 240}, intermediate2 + 1);
      ++actual_arc;
      assert_arc(*actual_arc, irs::RangeLabel{241, 255}, intermediate2);
      ++actual_arc;
      ASSERT_EQ(actual_arc, actual_arcs.arcs + actual_arcs.narcs);
    }
    ...
    // arcs from 'intermediate2+1'
    {
      ...
      a.InitArcIterator(intermediate2 + 1, &actual_arcs);
      ASSERT_EQ(3, actual_arcs.narcs);
      assert_arc(actual_arcs.arcs[0], irs::RangeLabel{128, 158}, intermediate1);
      assert_arc(actual_arcs.arcs[1], irs::RangeLabel{159, 159},
                 intermediate2 + 2);
      assert_arc(actual_arcs.arcs[2], irs::RangeLabel{160, 191}, intermediate1);
    }
    ...
    // arcs from 'intermediate2+2'
    {
      ...
      a.InitArcIterator(intermediate2 + 2, &actual_arcs);
      ASSERT_EQ(3, actual_arcs.narcs);
      assert_arc(actual_arcs.arcs[0], irs::RangeLabel{128, 151}, intermediate0);
      assert_arc(actual_arcs.arcs[1], irs::RangeLabel{152, 152},
                 intermediate2 + 3);
      assert_arc(actual_arcs.arcs[2], irs::RangeLabel{153, 191}, intermediate0);
    }
    ...
    // arcs from 'intermediate2+3'
    {
      ...
      ASSERT_EQ(3, actual_arcs.narcs);
      assert_arc(actual_arcs.arcs[0], irs::RangeLabel{128, 128}, def);
      assert_arc(actual_arcs.arcs[1], irs::RangeLabel{129, 129}, finish);
      assert_arc(actual_arcs.arcs[2], irs::RangeLabel{130, 191}, def);
    }
...
TEST_F(Utf8EmplaceArcTest, emplace_arc_rho_arc) {
  irs::automaton a;
  auto start = a.AddState();
  auto finish = a.AddState();
  a.SetStart(start);
  ...
  auto intermediate1 = a.NumStates() + 1;
  auto intermediate2 = a.NumStates() + 2;
  irs::Utf8EmplaceRhoArc(a, start, finish);
...

  {
    ...
    ASSERT_EQ(4, actual_arcs.narcs);
    auto* actual_arc = actual_arcs.arcs;
    AssertArc(*actual_arc, irs::RangeLabel::From(0, 127), finish);
    ++actual_arc;
    AssertArc(*actual_arc, irs::RangeLabel::From(194, 223), intermediate0);
    ++actual_arc;
    AssertArc(*actual_arc, irs::RangeLabel::From(224, 239), intermediate1);
...
TEST_F(Utf8EmplaceArcTest, add_or_expand) {
  irs::automaton a;
  auto start = a.AddState();
  auto finish = a.AddState();
  a.SetStart(start);
  ...
  irs::AddOrExpandArc(a, start, irs::RangeLabel::From(0, 5), finish);

  {
    ...
    ASSERT_EQ(irs::RangeLabel::From(0, 5), actual_arcs.arcs[0]);
  }

  irs::AddOrExpandArc(a, start, irs::RangeLabel::From(5), finish);
  ...
  irs::AddOrExpandArc(a, start, irs::RangeLabel::From(5, 6), finish);

  {
    ...
    ASSERT_EQ(1, actual_arcs.narcs);
    ASSERT_EQ(finish, actual_arcs.arcs[0].nextstate);
    ASSERT_EQ(irs::RangeLabel::From(0, 6), actual_arcs.arcs[0]);
  }

  irs::AddOrExpandArc(a, start, irs::RangeLabel::From(7, 9), finish);

  {
    ...
    ASSERT_EQ(1, actual_arcs.narcs);
    ASSERT_EQ(finish, actual_arcs.arcs[0].nextstate);
    ASSERT_EQ(irs::RangeLabel::From(0, 9), actual_arcs.arcs[0]);
  }

  irs::AddOrExpandArc(a, start, irs::RangeLabel::From(11), finish);

  {
    ...
    ASSERT_EQ(irs::RangeLabel::From(11), actual_arcs.arcs[1]);
  }

  irs::AddOrExpandArc(a, start, irs::RangeLabel::From(12), start);

  {
    ...
    ASSERT_EQ(irs::RangeLabel::From(12), actual_arcs.arcs[2]);
  }
}
...
//
//    const std::vector<std::vector<std::pair<irs::automaton::Arc::Label,
irs::automaton::StateId>>> expected_automaton{
...
//
//    auto* actual_arc = actual_arcs.arcs;
//    irs::automaton::Arc::Label label = 1; // 0 is reserved for Epsilon
transition
//
//    for (; label < 192; ++label) {
...
//    a.SetStart(start);
//
//    std::vector<std::pair<irs::automaton::Arc::Label,
irs::automaton::StateId>> arcs;
//    arcs.emplace_back('a', finish0);
//    arcs.emplace_back('0', finish0);
//    arcs.emplace_back('7', finish1);
//    arcs.emplace_back('U', finish0);
...
//    assert_properties(a);
//
//    std::vector<std::vector<std::pair<irs::automaton::Arc::Label,
irs::automaton::StateId>>> expected_automaton {
//      { { 48, 1 }, { 55, 2 }, { 85, 1 }, { 97, 1 },
