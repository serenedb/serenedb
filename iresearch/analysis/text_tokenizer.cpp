...
template<analysis::TextTokenizer::Options::Separate S>
struct Type<analysis::UnicodeAnalyzerImpl<S>> : Type<analysis::TextTokenizer> {
};

}  // namespace irs
namespace irs::analysis {

Tokenizer::ptr TextTokenizer::Make(Options options) {
