...
class TextTokenizer : private util::Noncopyable {
 public:
...
customize::enum_name<irs::analysis::TextTokenizer::Options::Accept>(
  irs::analysis::TextTokenizer::Options::Accept value) noexcept {
  using Accept = irs::analysis::TextTokenizer::Options::Accept;
  switch (value) {
    case Accept::Any:
      return "all";
    case Accept::Graphic:
...
template<>
struct DispatchValues<analysis::TextTokenizer::Options::Accept> {
  using Accept = analysis::TextTokenizer::Options::Accept;
