...
#define ERRCODE_INVALID_PRECEDING_OR_FOLLOWING_SIZE \
  MAKE_SQLSTATE('2', '2', '0', '1', '3')
...
#define ERRCODE_SEQUENCE_GENERATOR_LIMIT_EXCEEDED \
  MAKE_SQLSTATE('2', '2', '0', '0', 'H')
...
#define ERRCODE_DUPLICATE_JSON_OBJECT_KEY_VALUE \
  MAKE_SQLSTATE('2', '2', '0', '3', '0')
#define ERRCODE_INVALID_ARGUMENT_FOR_SQL_JSON_DATETIME_FUNCTION \
  MAKE_SQLSTATE('2', '2', '0', '3', '1')
#define ERRCODE_INVALID_JSON_TEXT MAKE_SQLSTATE('2', '2', '0', '3', '2')
#define ERRCODE_INVALID_SQL_JSON_SUBSCRIPT \
  MAKE_SQLSTATE('2', '2', '0', '3', '3')
#define ERRCODE_MORE_THAN_ONE_SQL_JSON_ITEM \
  MAKE_SQLSTATE('2', '2', '0', '3', '4')
#define ERRCODE_NO_SQL_JSON_ITEM MAKE_SQLSTATE('2', '2', '0', '3', '5')
#define ERRCODE_NON_NUMERIC_SQL_JSON_ITEM MAKE_SQLSTATE('2', '2', '0', '3', '6')
#define ERRCODE_NON_UNIQUE_KEYS_IN_A_JSON_OBJECT \
  MAKE_SQLSTATE('2', '2', '0', '3', '7')
#define ERRCODE_SINGLETON_SQL_JSON_ITEM_REQUIRED \
  MAKE_SQLSTATE('2', '2', '0', '3', '8')
...
#define ERRCODE_TOO_MANY_JSON_ARRAY_ELEMENTS \
  MAKE_SQLSTATE('2', '2', '0', '3', 'D')
#define ERRCODE_TOO_MANY_JSON_OBJECT_MEMBERS \
  MAKE_SQLSTATE('2', '2', '0', '3', 'E')
#define ERRCODE_SQL_JSON_SCALAR_REQUIRED MAKE_SQLSTATE('2', '2', '0', '3', 'F')
#define ERRCODE_SQL_JSON_ITEM_CANNOT_BE_CAST_TO_TARGET_TYPE \
  MAKE_SQLSTATE('2', '2', '0', '3', 'G')
...
#define ERRCODE_UNSAFE_NEW_ENUM_VALUE_USAGE \
  MAKE_SQLSTATE('5', '5', 'P', '0', '4')
