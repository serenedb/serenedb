...
class H1Connection final : public fuerte::GeneralConnection<ST, RequestItem> {
 ...
 private:
  ...
  fuerte::Error TranslateError(const asio_ns::error_code& e,
    ...
    if (e == asio_ns::error::misc_errors::eof ||
      ...
      return this->_timeout_on_read_write ? fuerte::Error::RequestTimeout
 ...
 private:
  ...
  vpack::BufferUInt8 _response_buffer;
  ...
  std::unique_ptr<sdb::fuerte::Response> _response;

  bool _last_header_was_value = false;
