...
class RandomMask : public RandomStringMask {
 public:
  ...
  void mask(bool, vpack::Builder& out, std::string& buffer) const override;
  void mask(int64_t, vpack::Builder& out, std::string& buffer) const override;
  void mask(double, vpack::Builder& out, std::string& buffer) const override;
