...
SDB_STRESS_PROFILE=${SDB_STRESS_PROFILE:-}
SDB_STRESS_SCENARIO=${SDB_STRESS_SCENARIO:-}
SDB_STRESS_SECONDS=${SDB_STRESS_SECONDS:-}
SDB_STRESS_WORKERS=${SDB_STRESS_WORKERS:-}
SDB_STRESS_SEED=${SDB_STRESS_SEED:-}
EOF
