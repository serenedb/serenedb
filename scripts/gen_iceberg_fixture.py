#!/usr/bin/env python3
"""Generates tests/sqllogic/fixtures/iceberg: two local iceberg
...
Deps (not in CI -- the fixture is static, regenerate manually):
  python3 -m venv v && v/bin/pip install 'pyiceberg[sql-sqlite]' pyarrow fastavro
  v/bin/python scripts/gen_iceberg_fixture.py
...
OUT = os.path.join(REPO, "tests", "sqllogic", "fixtures", "iceberg")
