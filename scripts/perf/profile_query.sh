...
#   PERF_DICT_TEMPLATE  split_text_csv (default) | split_text -- match the bench you're
#                       investigating.
...
DICT_TEMPLATE="${PERF_DICT_TEMPLATE:-split_text_csv}"
...
split_text)
	...
	;;
*)
	echo "PERF_DICT_TEMPLATE must be 'split_text_csv' or 'split_text', got '${DICT_TEMPLATE}'" >&2
	exit 1
	;;
esac
