...
export const ConsoleExecutionHistory = () => {
    ...
    const selectedFilterTab = useMemo(
        () =>
            openTabs.find((tab) => tab.panelId === executionHistoryPanelFilter),
        [executionHistoryPanelFilter, openTabs],
    );
    ...
    const filterLabel = useMemo(() => {
        ...
        if (selectedFilterTab) {
            return `${selectedFilterTab.title} • ${selectedFilterTab.panelId.slice(-8)}`;
        }

        return executionHistoryPanelFilter.slice(-8);
    }, [executionHistoryPanelFilter, selectedFilterTab]);
    ...
    const renderRunningList = () => (
        <>
            ...
            <input
                ...
                className="h-9 w-full border-0 border-t-[0.5px] border-border bg-transparent px-3 text-xs text-foreground placeholder:text-muted-foreground outline-none"
            />
        </>
    );
        ...
        <>
            ...
            <Popover
                ...
                <PopoverContent
                    align="start"
                    sideOffset={0}
                    className="rounded-none border-[0.5px] p-0">
                    <div className="max-h-56 overflow-y-auto">
                        <button
                            type="button"
                            className={cn(
                                "h-9 w-full border-b-[0.5px] px-3 text-left text-xs hover:bg-accent/40",
                                executionHistoryPanelFilter ===
            ...
            <div className="flex">
                <input
                    ...
                    className="h-9 min-w-0 flex-1 border-0 border-t-[0.5px] border-border bg-transparent px-3 text-xs text-foreground placeholder:text-muted-foreground outline-none"
                />
                <Button
                    variant="ghost"
                    size="icon"
