    ...
    <div className={cn("space-y-2", disabled && "opacity-60")}>
        <div className="flex items-start justify-between gap-2">
            <Label
                htmlFor={htmlFor}
                className={cn(
                    "text-xs leading-5 font-medium text-primary-foreground",
            ...
            <Tooltip>
                <TooltipTrigger asChild>
                    <button
                        type="button"
                        tabIndex={0}
                        className="mt-[2px] text-secondary-foreground/70 hover:text-secondary-foreground transition-colors"
                ...
                <div className="space-y-4 pb-2">
                    ...
                    <ConsoleSettingField
                        ...
                        <div className="flex items-center gap-2">
                            <Checkbox
                                id="console-settings-spawn-first-results-tab"
                    ...
                    <ConsoleSettingField
                        ...
                        <div className="flex items-center gap-2">
                            <Checkbox
                                id="console-settings-colorful-types"
                    ...
                    <ConsoleSettingField
                        ...
                        <div className="flex items-center gap-2">
                            <Checkbox
                                id="console-settings-select-related-result"
                    ...
                    <ConsoleSettingField
                        ...
                        <div className="flex items-center gap-2">
                            <Checkbox
                                id="console-settings-show-json-default"
                    ...
                    <ConsoleSettingField
                        ...
                        <div className="flex items-center gap-2">
                            <Checkbox
                                id="console-settings-show-autocomplete"
                    ...
                    <ConsoleSettingField
                        ...
                        <div className="flex items-center gap-2">
                            <Checkbox
                                id="console-settings-show-saved-autocomplete"
                    ...
                    <ConsoleSettingField
                        ...
                        <div className="flex items-center gap-2">
                            <Checkbox
                                id="console-settings-show-history-autocomplete"
                    ...
                    <ConsoleSettingField
                        ...
                        <div className="flex items-center gap-2">
                            <Checkbox
                                id="console-settings-sequential-default"
                    ...
                    <ConsoleSettingField
                        ...
                        <div className="flex items-center gap-2">
                            <Checkbox
                                id="console-settings-new-tab-default"
