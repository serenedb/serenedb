...
> = ({
    ...
    const activeSeries = series.find((item) => item.key === activeChart) ?? series[0];
                ...
                ? [
                      {
                          ...
                          itemStyle: {
                              color: resolveEChartColor(activeSeries.color),
                              borderRadius: 4,
                          },
                      },
                  ]
    ...
    }, [activeKey, activeSeries, data, formatTooltipLabel, formatXAxisTick, xAxisKey]);
    ...
    return (
        <div className="bg-background border-1 rounded-xs flex min-h-0 flex-1 flex-col overflow-hidden">
            ...
            {isMoving ? (
                ...
                <div className="aspect-auto flex-1 min-h-0 w-full">
                    <ReactECharts
                        option={chartOption}
                        notMerge
                        lazyUpdate
