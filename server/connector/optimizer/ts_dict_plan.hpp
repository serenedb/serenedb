...
// GROUP BY / aggregate pushdowns onto the term dictionary and the
// ts_dict WHERE claim. Split out of iresearch_plan.cpp; shares its
// planner helpers via iresearch_plan_common.hpp.
