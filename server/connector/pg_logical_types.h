...
// clang-format off
DECLARE_PG_TYPE(OID,            Oid,            "oid",            UBIGINT)
DECLARE_PG_TYPE(REGTYPE,        Regtype,        "regtype",        UBIGINT)
DECLARE_PG_TYPE(REGCLASS,       Regclass,       "regclass",       UBIGINT)
DECLARE_PG_TYPE(REGPROC,        Regproc,        "regproc",        UBIGINT)
DECLARE_PG_TYPE(REGNAMESPACE,   Regnamespace,   "regnamespace",   UBIGINT)
DECLARE_PG_TYPE(REGOPER,        Regoper,        "regoper",        UBIGINT)
DECLARE_PG_TYPE(REGOPERATOR,    Regoperator,    "regoperator",    UBIGINT)
DECLARE_PG_TYPE(REGPROCEDURE,   Regprocedure,   "regprocedure",   UBIGINT)
DECLARE_PG_TYPE(REGROLE,        Regrole,        "regrole",        UBIGINT)
DECLARE_PG_TYPE(REGCONFIG,      Regconfig,      "regconfig",      UBIGINT)
DECLARE_PG_TYPE(REGDICTIONARY,  Regdictionary,  "regdictionary",  UBIGINT)
DECLARE_PG_TYPE(REGCOLLATION,   Regcollation,   "regcollation",   UBIGINT)
DECLARE_PG_TYPE(TID,            Tid,            "tid",            UBIGINT)
DECLARE_PG_TYPE(CID,            Cid,            "cid",            UBIGINT)
DECLARE_PG_TYPE(XID,            Xid,            "xid",            UBIGINT)
DECLARE_PG_TYPE(XID8,           Xid8,           "xid8",           UBIGINT)
