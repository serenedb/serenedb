...
// Elasticsearch-style bool query. Each of the first three args is
// either a single TSQUERY (push as-is), a TSQUERY[] (extract
// children), or NULL (no clauses). Builds:
//   And { ...must, ...Not(must_not), Or{...should, min_match=N} }
