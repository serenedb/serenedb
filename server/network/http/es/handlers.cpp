...
yaclib::Task<bool> MaybeRefresh(RequestContext& ctx, const HttpRequest& request,
...
yaclib::Task<bool> RunAggregation(RequestContext& ctx, const Aggregation& agg,
...
// false = the error response is already written.
yaclib::Task<bool> FetchFieldTypes(RequestContext& ctx, std::string_view index,
                                   FieldTypes& fields,
                                   http::HttpResponseWriter& writer) {
  auto result = co_await RunSql(
...
class SearchHandler final : public HttpHandler {
 ...
 private:
  ...
  yaclib::Task<> HandleScroll(RequestContext& ctx, const HttpRequest& request,
                              http::HttpResponseWriter& writer,
