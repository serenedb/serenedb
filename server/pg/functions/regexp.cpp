...
// regexp_match(string, pattern) -> array<velox::Varchar>
...
// regexp_count(string, pattern) -> int64
...
// regexp_instr(string, pattern) -> int64
...
// regexp_instr(string, pattern, start, N) -> int64
...
// regexp_substr(string, pattern) -> varchar
