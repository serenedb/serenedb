...
void registerVectorFunctions(const std::string& prefix) {
  velox::registerFunction<L2Squared, float, velox::Array<float>,
                          velox::Array<float>>({prefix + "l2_squared"});
  velox::registerFunction<L1Distance, float, velox::Array<float>,
                          velox::Array<float>>({prefix + "l1_distance"});
  velox::registerFunction<CosineSimilarity, float, velox::Array<float>,
