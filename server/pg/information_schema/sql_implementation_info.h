...
struct SqlImplementationInfo {
  ...
  static constexpr std::string_view kName = "sql_implementation_info";

  CharacterData implementation_info_id;
  CharacterData implementation_info_name;
  CardinalNumber integer_value;
  CharacterData character_value;
