...
template<>
std::vector<velox::VectorPtr> SystemTableSnapshot<PgDatabase>::GetTableData(
  ...
  result.reserve(boost::pfr::tuple_size_v<PgDatabase>);
  boost::pfr::for_each_field(
    PgDatabase{}, [&]<typename Field>(const Field& field) {
