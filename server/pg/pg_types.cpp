...
std::string RegtypeOut(uint64_t oid) {
  switch (static_cast<PgTypeOID>(oid)) {
    SDB_REGTYPE_WITH_ARRAY_OUT(kBool, "bool")
    ...
    SDB_REGTYPE_WITH_ARRAY_OUT(kBpchar, "bpchar")
    SDB_REGTYPE_WITH_ARRAY_OUT(kVarchar, "varchar")
    SDB_REGTYPE_WITH_ARRAY_OUT(kDate, "date")
    SDB_REGTYPE_WITH_ARRAY_OUT(kTime, "time")
    SDB_REGTYPE_WITH_ARRAY_OUT(kTimestamp, "timestamp")
    SDB_REGTYPE_WITH_ARRAY_OUT(kTimestampTz, "timestamptz")
