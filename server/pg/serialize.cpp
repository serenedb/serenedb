  ...
  switch (type->kind()) {
    ...
    case velox::TypeKind::REAL: {
      ...
      static constexpr auto kOid =
        GetPrimitiveTypeOID(velox::TypeKind::REAL, false);
    ...
    case velox::TypeKind::DOUBLE: {
      ...
      static constexpr auto kOid =
        GetPrimitiveTypeOID(velox::TypeKind::DOUBLE, false);
      return irs::ResolveBool(
        context.extra_float_digits > 0, [&]<bool Precise> {
          static constexpr auto kSerializeText =
    ...
    case velox::TypeKind::VARCHAR: {
      static constexpr auto kOid =
        GetPrimitiveTypeOID(velox::TypeKind::VARCHAR, false);
      static constexpr auto kSerializeText =
    ...
    case velox::TypeKind::VARBINARY: {
      static constexpr auto kOid =
        GetPrimitiveTypeOID(velox::TypeKind::VARBINARY, false);
