...
constexpr containers::TrivialBiMap kMapping = [](auto selector) {
  return selector()
    ...
    .Case("pg_stat_get_tuples_returned", VeloxFunction{"pg_stat_get_tuples_returned"})
    .Case("pg_stat_get_tuples_fetched", VeloxFunction{"pg_stat_get_tuples_fetched"})
    .Case("pg_stat_get_tuples_inserted", VeloxFunction{"pg_stat_get_tuples_inserted"})
    .Case("pg_stat_get_tuples_updated", VeloxFunction{"pg_stat_get_tuples_updated"})
    .Case("pg_stat_get_tuples_deleted", VeloxFunction{"pg_stat_get_tuples_deleted"})
    .Case("pg_stat_get_tuples_hot_updated", VeloxFunction{"pg_stat_get_tuples_hot_updated"})
    .Case("pg_stat_get_tuples_newpage_updated", VeloxFunction{"pg_stat_get_tuples_newpage_updated"})
    ...
    .Case("pg_stat_get_mod_since_analyze", VeloxFunction{"pg_stat_get_mod_since_analyze"})
    .Case("pg_stat_get_ins_since_vacuum", VeloxFunction{"pg_stat_get_ins_since_vacuum"})
    .Case("pg_stat_get_vacuum_count", VeloxFunction{"pg_stat_get_vacuum_count"})
    .Case("pg_stat_get_autovacuum_count", VeloxFunction{"pg_stat_get_autovacuum_count"})
    .Case("pg_stat_get_analyze_count", VeloxFunction{"pg_stat_get_analyze_count"})
    .Case("pg_stat_get_autoanalyze_count", VeloxFunction{"pg_stat_get_autoanalyze_count"})
    .Case("pg_stat_get_blocks_fetched", VeloxFunction{"pg_stat_get_blocks_fetched"})
    .Case("pg_stat_get_blocks_hit", VeloxFunction{"pg_stat_get_blocks_hit"})
    .Case("pg_stat_get_xact_numscans", VeloxFunction{"pg_stat_get_xact_numscans"})
    .Case("pg_stat_get_xact_tuples_returned", VeloxFunction{"pg_stat_get_xact_tuples_returned"})
    .Case("pg_stat_get_xact_tuples_fetched", VeloxFunction{"pg_stat_get_xact_tuples_fetched"})
    .Case("pg_stat_get_xact_tuples_inserted", VeloxFunction{"pg_stat_get_xact_tuples_inserted"})
    .Case("pg_stat_get_xact_tuples_updated", VeloxFunction{"pg_stat_get_xact_tuples_updated"})
    .Case("pg_stat_get_xact_tuples_deleted", VeloxFunction{"pg_stat_get_xact_tuples_deleted"})
    .Case("pg_stat_get_xact_tuples_hot_updated", VeloxFunction{"pg_stat_get_xact_tuples_hot_updated"})
    .Case("pg_stat_get_xact_tuples_newpage_updated", VeloxFunction{"pg_stat_get_xact_tuples_newpage_updated"})
    .Case("pg_stat_get_function_calls", VeloxFunction{"pg_stat_get_function_calls"})
    .Case("pg_stat_get_xact_function_calls", VeloxFunction{"pg_stat_get_xact_function_calls"})
    .Case("pg_stat_get_db_numbackends", VeloxFunction{"pg_stat_get_db_numbackends"})
    .Case("pg_stat_get_db_xact_commit", VeloxFunction{"pg_stat_get_db_xact_commit"})
    .Case("pg_stat_get_db_xact_rollback", VeloxFunction{"pg_stat_get_db_xact_rollback"})
    .Case("pg_stat_get_db_blocks_fetched", VeloxFunction{"pg_stat_get_db_blocks_fetched"})
    .Case("pg_stat_get_db_blocks_hit", VeloxFunction{"pg_stat_get_db_blocks_hit"})
    .Case("pg_stat_get_db_tuples_returned", VeloxFunction{"pg_stat_get_db_tuples_returned"})
    .Case("pg_stat_get_db_tuples_fetched", VeloxFunction{"pg_stat_get_db_tuples_fetched"})
    .Case("pg_stat_get_db_tuples_inserted", VeloxFunction{"pg_stat_get_db_tuples_inserted"})
    .Case("pg_stat_get_db_tuples_updated", VeloxFunction{"pg_stat_get_db_tuples_updated"})
    .Case("pg_stat_get_db_tuples_deleted", VeloxFunction{"pg_stat_get_db_tuples_deleted"})
    .Case("pg_stat_get_db_conflict_all", VeloxFunction{"pg_stat_get_db_conflict_all"})
    .Case("pg_stat_get_db_temp_files", VeloxFunction{"pg_stat_get_db_temp_files"})
    .Case("pg_stat_get_db_temp_bytes", VeloxFunction{"pg_stat_get_db_temp_bytes"})
    .Case("pg_stat_get_db_deadlocks", VeloxFunction{"pg_stat_get_db_deadlocks"})
    .Case("pg_stat_get_db_checksum_failures", VeloxFunction{"pg_stat_get_db_checksum_failures"})
    .Case("pg_stat_get_db_sessions", VeloxFunction{"pg_stat_get_db_sessions"})
    .Case("pg_stat_get_db_sessions_abandoned", VeloxFunction{"pg_stat_get_db_sessions_abandoned"})
    .Case("pg_stat_get_db_sessions_fatal", VeloxFunction{"pg_stat_get_db_sessions_fatal"})
    .Case("pg_stat_get_db_sessions_killed", VeloxFunction{"pg_stat_get_db_sessions_killed"})
    .Case("pg_stat_get_db_parallel_workers_to_launch", VeloxFunction{"pg_stat_get_db_parallel_workers_to_launch"})
    .Case("pg_stat_get_db_parallel_workers_launched", VeloxFunction{"pg_stat_get_db_parallel_workers_launched"})
    .Case("pg_stat_get_db_conflict_tablespace", VeloxFunction{"pg_stat_get_db_conflict_tablespace"})
    .Case("pg_stat_get_db_conflict_lock", VeloxFunction{"pg_stat_get_db_conflict_lock"})
    .Case("pg_stat_get_db_conflict_snapshot", VeloxFunction{"pg_stat_get_db_conflict_snapshot"})
    .Case("pg_stat_get_db_conflict_bufferpin", VeloxFunction{"pg_stat_get_db_conflict_bufferpin"})
    .Case("pg_stat_get_db_conflict_startup_deadlock", VeloxFunction{"pg_stat_get_db_conflict_startup_deadlock"})
    .Case("pg_stat_get_db_conflict_logicalslot", VeloxFunction{"pg_stat_get_db_conflict_logicalslot"})
    // Functions taking OID, returning double precision
    .Case("pg_stat_get_total_vacuum_time", VeloxFunction{"pg_stat_get_total_vacuum_time"})
    .Case("pg_stat_get_total_autovacuum_time", VeloxFunction{"pg_stat_get_total_autovacuum_time"})
    .Case("pg_stat_get_total_analyze_time", VeloxFunction{"pg_stat_get_total_analyze_time"})
    .Case("pg_stat_get_total_autoanalyze_time", VeloxFunction{"pg_stat_get_total_autoanalyze_time"})
    .Case("pg_stat_get_function_total_time", VeloxFunction{"pg_stat_get_function_total_time"})
    .Case("pg_stat_get_function_self_time", VeloxFunction{"pg_stat_get_function_self_time"})
    .Case("pg_stat_get_xact_function_total_time", VeloxFunction{"pg_stat_get_xact_function_total_time"})
    .Case("pg_stat_get_xact_function_self_time", VeloxFunction{"pg_stat_get_xact_function_self_time"})
    .Case("pg_stat_get_db_blk_read_time", VeloxFunction{"pg_stat_get_db_blk_read_time"})
    .Case("pg_stat_get_db_blk_write_time", VeloxFunction{"pg_stat_get_db_blk_write_time"})
    .Case("pg_stat_get_db_session_time", VeloxFunction{"pg_stat_get_db_session_time"})
    .Case("pg_stat_get_db_active_time", VeloxFunction{"pg_stat_get_db_active_time"})
    .Case("pg_stat_get_db_idle_in_transaction_time", VeloxFunction{"pg_stat_get_db_idle_in_transaction_time"})
    // Functions taking OID, returning timestamp
    .Case("pg_stat_get_lastscan", VeloxFunction{"pg_stat_get_lastscan"})
    .Case("pg_stat_get_last_vacuum_time", VeloxFunction{"pg_stat_get_last_vacuum_time"})
    .Case("pg_stat_get_last_autovacuum_time", VeloxFunction{"pg_stat_get_last_autovacuum_time"})
    .Case("pg_stat_get_last_analyze_time", VeloxFunction{"pg_stat_get_last_analyze_time"})
    .Case("pg_stat_get_last_autoanalyze_time", VeloxFunction{"pg_stat_get_last_autoanalyze_time"})
    .Case("pg_stat_get_stat_reset_time", VeloxFunction{"pg_stat_get_stat_reset_time"})
    .Case("pg_stat_get_function_stat_reset_time", VeloxFunction{"pg_stat_get_function_stat_reset_time"})
    .Case("pg_stat_get_db_stat_reset_time", VeloxFunction{"pg_stat_get_db_stat_reset_time"})
    .Case("pg_stat_get_db_checksum_last_failure", VeloxFunction{"pg_stat_get_db_checksum_last_failure"})
    // Parameterless functions returning bigint
    .Case("pg_stat_get_bgwriter_buf_written_clean", VeloxFunction{"pg_stat_get_bgwriter_buf_written_clean"})
    .Case("pg_stat_get_bgwriter_maxwritten_clean", VeloxFunction{"pg_stat_get_bgwriter_maxwritten_clean"})
    .Case("pg_stat_get_buf_alloc", VeloxFunction{"pg_stat_get_buf_alloc"})
    .Case("pg_stat_get_checkpointer_num_timed", VeloxFunction{"pg_stat_get_checkpointer_num_timed"})
    .Case("pg_stat_get_checkpointer_num_requested", VeloxFunction{"pg_stat_get_checkpointer_num_requested"})
    .Case("pg_stat_get_checkpointer_num_performed", VeloxFunction{"pg_stat_get_checkpointer_num_performed"})
    .Case("pg_stat_get_checkpointer_restartpoints_timed", VeloxFunction{"pg_stat_get_checkpointer_restartpoints_timed"})
    .Case("pg_stat_get_checkpointer_restartpoints_requested", VeloxFunction{"pg_stat_get_checkpointer_restartpoints_requested"})
    .Case("pg_stat_get_checkpointer_restartpoints_performed", VeloxFunction{"pg_stat_get_checkpointer_restartpoints_performed"})
    .Case("pg_stat_get_checkpointer_buffers_written", VeloxFunction{"pg_stat_get_checkpointer_buffers_written"})
    .Case("pg_stat_get_checkpointer_slru_written", VeloxFunction{"pg_stat_get_checkpointer_slru_written"})
    // Parameterless functions returning double precision
    .Case("pg_stat_get_checkpointer_write_time", VeloxFunction{"pg_stat_get_checkpointer_write_time"})
    .Case("pg_stat_get_checkpointer_sync_time", VeloxFunction{"pg_stat_get_checkpointer_sync_time"})
    // Parameterless functions returning timestamp
    .Case("pg_stat_get_bgwriter_stat_reset_time", VeloxFunction{"pg_stat_get_bgwriter_stat_reset_time"})
    .Case("pg_stat_get_checkpointer_stat_reset_time", VeloxFunction{"pg_stat_get_checkpointer_stat_reset_time"})
    // Other scalar stubs
    ...
    .Case("pg_get_function_arg_default", VeloxFunction{"pg_get_function_arg_default"})
    .Case("pg_get_statisticsobjdef_expressions", VeloxFunction{"pg_get_statisticsobjdef_expressions"})
    // Search functions
