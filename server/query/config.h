...
class Config {
 public:
  ...
  // The catalog identity a plan is cached against (SereneDBCatalog::
  // GetCatalogVersion, duckdb's PreparedStatementData::RequireRebind). It
  // moves whenever anything mutates the catalog -- another session's DDL, or
  // this session's own.
  //
