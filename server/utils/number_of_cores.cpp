...
irs::containers::FlatHashSet<int64_t> ParseCpuList(std::string_view list) {
  irs::containers::FlatHashSet<int64_t> cpus;
...
irs::containers::FlatHashSet<int64_t> AllowedCpuSet() {
...
irs::containers::FlatHashMap<int64_t, std::pair<int64_t, int64_t>>
CpuCoreMap() {
  std::ifstream f("/proc/cpuinfo");
  irs::containers::FlatHashMap<int64_t, std::pair<int64_t, int64_t>> map;
  int64_t cpu = -1;
