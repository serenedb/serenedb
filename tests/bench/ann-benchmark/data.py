"""
Downloads MNIST and converts each image into a normalized float vector.
...
def main():
    ...
    paths = {k: download(v, raw_dir) for k, v in MNIST_FILES.items()}
    ...
    for split in ("train", "test"):
        ...
        records = [{"id": idx, "label": lbl, "vector": vec} for idx, (vec, lbl) in enumerate(pairs)]

        out_path = OUTPUT_DIR / f"mnist_{split}.json"
