...
for extra in test_copy test_shell_copy test_psql_mode test_pgwire_raw test_search_params test_dictionary_chains test_otel_api test_mcp_api test_docs_build; do
