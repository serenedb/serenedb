...
TEST(ngram_token_stream_test, reset_too_big) {
  irs::analysis::NGramTokenizer stream(
    irs::analysis::NGramTokenizerBase::Options(1, 1, false));
...
TEST(ngram_token_stream_test, next) {
...

  {
    ...
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(1, 1, true));
...

  {
    SCOPED_TRACE("2-gram");
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(2, 2, false));
...

  {
    SCOPED_TRACE("1..2-gram");
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(1, 2, false));
...

  {
    SCOPED_TRACE("3-gram");
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(3, 3, false));
...

  {
    ...
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(1, 3, false));
...

  {
    ...
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(2, 3, false));
...

  {
    ...
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(2, 3, true));
...

  {
    SCOPED_TRACE("4-gram invalid utf8");
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(4, 4, false));
...

  {
    ...
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(1, 4, false));
...

  {
    SCOPED_TRACE("5-gram");
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(5, 5, false));
...

  {
    SCOPED_TRACE("5-gram, preserve original");
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(5, 5, true));
...

  {
    ...
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(4, 5, true));
...

  {
    ...
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(4, 5, false));
...

  {
    SCOPED_TRACE("6-gram, preserve original");
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(6, 6, true));
...

  {
    SCOPED_TRACE("6-gram no output");
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(6, 6, false));
...

  {
    ...
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(1, 5, false));
...

  {
    ...
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(3, 5, false));
...

  {
    ...
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(1, 6, false));
...

  {
    ...
    irs::analysis::NGramTokenizer stream(
      irs::analysis::NGramTokenizerBase::Options(1, 6, true));
...
TEST(ngram_token_stream_test, native_fills_match_pull_binary) {
  ASSERT_TRUE(
    irs::analysis::NGramTokenizer{irs::analysis::NGramTokenizerBase::Options{}}
      .Traits()
      .explicit_pos);
...
void AssertModeFill(irs::analysis::NGramTokenizerBase::Options opts,
                    std::string_view data,
                    const std::vector<ExpectedNgram>& expected) {
  using UTF8 =
    std::integral_constant<irs::analysis::NGramTokenizerBase::InputType,
                           irs::analysis::NGramTokenizerBase::InputType::UTF8>;
...
irs::analysis::NGramTokenizerBase::Options ModeOptions(
  size_t min, size_t max, bool preserve,
  irs::analysis::NGramTokenizerBase::NGramMode mode) {
  irs::analysis::NGramTokenizerBase::Options opts;
  opts.min_gram = min;
  opts.max_gram = max;
  opts.preserve_original = preserve;
...
TEST(ngram_token_stream_test, only_prefix_ascii) {
  using Mode = irs::analysis::NGramTokenizerBase::NGramMode;
...
TEST(ngram_token_stream_test, only_prefix_and_suffix_ascii) {
  ...
  AssertModeFill(
    ...
    {{"a", 1, 0, 1}, {"ab", 1, 0, 2}, {"d", 2, 3, 4}, {"cd", 2, 2, 4}});
}
