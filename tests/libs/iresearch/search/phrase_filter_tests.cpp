...
TEST_P(PhraseFilterTestCase, interval_combinations) {
  ...
  static constexpr Case kCases[] = {
    ...
    {"variadic interval offsets", Part::kPrefix, true, Entry::kOffsets, 0,
     false},
    {"boost match", Part::kEditDistance, false, Entry::kMatch, 0, false},
    {"boost score", Part::kEditDistance, false, Entry::kScore, 1, true},
    {"boost offsets", Part::kEditDistance, false, Entry::kOffsets, 0, false},
    {"boost interval match", Part::kEditDistance, true, Entry::kMatch, 0,
     false},
    {"boost interval score", Part::kEditDistance, true, Entry::kScore, 2, true},
    {"boost interval offsets", Part::kEditDistance, true, Entry::kOffsets, 0,
     false},
  };
