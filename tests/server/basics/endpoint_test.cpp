...
TEST(EndpointTest, EndpointInvalid) {
  ...
  EXPECT_TRUE(e == sdb::Endpoint::clientFactory("fish://127.0.0.1:7890"));
  EXPECT_TRUE(e == sdb::Endpoint::clientFactory("htp://127.0.0.1:7890"));
  EXPECT_TRUE(e == sdb::Endpoint::clientFactory("ftp://127.0.0.1:7890"));

  EXPECT_TRUE(e == sdb::Endpoint::clientFactory("tcp//127.0.0.1:7890"));
  EXPECT_TRUE(e == sdb::Endpoint::clientFactory("tcp:127.0.0.1:7890"));
  ...
  EXPECT_TRUE(e == sdb::Endpoint::clientFactory("fish@tcp://127.0.0.1:7890"));
  EXPECT_TRUE(e == sdb::Endpoint::clientFactory("ssl@tcp://127.0.0.1:7890"));
  EXPECT_TRUE(e == sdb::Endpoint::clientFactory("https@tcp://127.0.0.1:7890"));
...
TEST(EndpointTest, EndpointDomains) {
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://127.0.0.1:7890", domain, AF_INET);
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost:7890", domain, AF_INET);
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.serenedb.org:7890", domain,
                         AF_INET);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]", domain, AF_INET6);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[::]", domain, AF_INET6);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]:7890", domain, AF_INET6);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[::]:7890", domain, AF_INET6);
  CHECK_ENDPOINT_FEATURE(client,
                         "tcp://[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890",
                         domain, AF_INET6);
  CHECK_ENDPOINT_FEATURE(
    client, "http@tcp://[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890", domain,
    AF_INET6);
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://127.0.0.1:7890", domain, AF_INET);
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost:7890", domain, AF_INET);
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.serenedb.org:7890", domain,
                         AF_INET);
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]", domain, AF_INET6);
  CHECK_ENDPOINT_FEATURE(client, "ssl://[::]", domain, AF_INET6);
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]:7890", domain, AF_INET6);
  CHECK_ENDPOINT_FEATURE(client, "ssl://[::]:7890", domain, AF_INET6);
  CHECK_ENDPOINT_FEATURE(client,
                         "ssl://[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890",
                         domain, AF_INET6);
  CHECK_ENDPOINT_FEATURE(
    client, "http@ssl://[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890", domain,
    AF_INET6);
...
TEST(EndpointTest, EndpointDomainTypes) {
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.serenedb.org", domainType,
                         sdb::Endpoint::DomainType::IPv4);
  CHECK_ENDPOINT_FEATURE(client, "tcp://127.0.0.1:7890", domainType,
                         sdb::Endpoint::DomainType::IPv4);
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost:7890", domainType,
                         sdb::Endpoint::DomainType::IPv4);
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.serenedb.org:7890", domainType,
                         sdb::Endpoint::DomainType::IPv4);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]", domainType,
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]:7890", domainType,
                         sdb::Endpoint::DomainType::IPv6);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[::]:7890", domainType,
                         sdb::Endpoint::DomainType::IPv6);
  CHECK_ENDPOINT_FEATURE(client,
                         "tcp://[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890",
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.serenedb.org", domainType,
                         sdb::Endpoint::DomainType::IPv4);
  CHECK_ENDPOINT_FEATURE(client, "ssl://127.0.0.1:7890", domainType,
                         sdb::Endpoint::DomainType::IPv4);
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost:7890", domainType,
                         sdb::Endpoint::DomainType::IPv4);
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.serenedb.org:7890", domainType,
                         sdb::Endpoint::DomainType::IPv4);
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]", domainType,
                         sdb::Endpoint::DomainType::IPv6);
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]:7890", domainType,
                         sdb::Endpoint::DomainType::IPv6);
  CHECK_ENDPOINT_FEATURE(client, "ssl://[::]:7890", domainType,
                         sdb::Endpoint::DomainType::IPv6);
  CHECK_ENDPOINT_FEATURE(client,
                         "ssl://[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890",
                         domainType, sdb::Endpoint::DomainType::IPv6);
...
TEST(EndpointTest, EndpointPorts) {
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.serenedb.org", port,
                         EndpointIp::kDefaultPortHttp);
  CHECK_ENDPOINT_FEATURE(client, "tcp://127.0.0.1:7890", port, 7890);
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost:7890", port, 7890);
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.serenedb.org:7890", port, 7890);
  CHECK_ENDPOINT_FEATURE(client, "http@tcp://www.serenedb.org:7890", port,
                         7890);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]", port,
                         EndpointIp::kDefaultPortHttp);
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]:443", port, 443);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]:65535", port, 65535);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[::]:7890", port, 7890);
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.serenedb.org", port,
                         EndpointIp::kDefaultPortHttp);
  CHECK_ENDPOINT_FEATURE(client, "ssl://127.0.0.1:7890", port, 7890);
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost:7890", port, 7890);
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.serenedb.org:7890", port, 7890);
  CHECK_ENDPOINT_FEATURE(client, "https://www.serenedb.org:7890", port, 7890);
  CHECK_ENDPOINT_FEATURE(client, "http@ssl://www.serenedb.org:7890", port,
                         7890);
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]", port,
                         EndpointIp::kDefaultPortHttp);
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]:443", port, 443);
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]:65535", port, 65535);
  CHECK_ENDPOINT_FEATURE(client, "ssl://[::]:7890", port, 7890);
...
TEST(EndpointTest, EndpointEncryption) {
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.serenedb.org", encryption,
                         sdb::Endpoint::EncryptionType::None);
  CHECK_ENDPOINT_FEATURE(client, "tcp://127.0.0.1:7890", encryption,
                         sdb::Endpoint::EncryptionType::None);
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost:7890", encryption,
                         sdb::Endpoint::EncryptionType::None);
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.serenedb.org:7890", encryption,
                         sdb::Endpoint::EncryptionType::None);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]", encryption,
                         sdb::Endpoint::EncryptionType::None);
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]:7890", encryption,
                         sdb::Endpoint::EncryptionType::None);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[::]:7890", encryption,
                         sdb::Endpoint::EncryptionType::None);
  CHECK_ENDPOINT_FEATURE(client,
  ...
  CHECK_ENDPOINT_FEATURE(
    ...
    encryption, sdb::Endpoint::EncryptionType::None);
  CHECK_ENDPOINT_FEATURE(client, "http://[::]:7890", encryption,
                         sdb::Endpoint::EncryptionType::None);
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.serenedb.org", encryption,
                         sdb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "ssl://127.0.0.1:7890", encryption,
                         sdb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost:7890", encryption,
                         sdb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.serenedb.org:7890", encryption,
                         sdb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]", encryption,
                         sdb::Endpoint::EncryptionType::SSL);
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://[::]:7890", encryption,
                         sdb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "SSL://[::]:7890", encryption,
                         sdb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "Ssl://[::]:7890", encryption,
  ...
  CHECK_ENDPOINT_FEATURE(client, "sSL://[::]:7890", encryption,
                         sdb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "http@ssl://[::]:7890", encryption,
                         sdb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "https://[::]:7890", encryption,
                         sdb::Endpoint::EncryptionType::SSL);
...
TEST(EndpointTest, EndpointHost) {
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://192.168.173.13:7890", host,
                         "192.168.173.13");
  CHECK_ENDPOINT_FEATURE(client, "tcp://127.0.0.1:7890", host, "127.0.0.1");
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost:7890", host, "127.0.0.1");
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.serenedb.org:7890", host,
                         "www.serenedb.org");
  CHECK_ENDPOINT_FEATURE(client, "tcp://serenedb.org:7890", host,
                         "serenedb.org");
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]", host, "127.0.0.1");
  CHECK_ENDPOINT_FEATURE(client, "tcp://[::]", host, "::");
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]:7890", host, "127.0.0.1");
  CHECK_ENDPOINT_FEATURE(client, "tcp://[::]:7890", host, "::");
  CHECK_ENDPOINT_FEATURE(client,
  ...
  CHECK_ENDPOINT_FEATURE(client,
                         "tcp://[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890",
                         host, "2001:0db8:0000:0000:0000:ff00:0042:8329");
  CHECK_ENDPOINT_FEATURE(client, "http@tcp://[::]:7890", host, "::");
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://DE.triagens.SereneDB.org", host,
                         "de.triagens.serenedb.org");
  CHECK_ENDPOINT_FEATURE(client, "ssl://192.168.173.13:7890", host,
                         "192.168.173.13");
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost:7890", host, "127.0.0.1");
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.serenedb.org:7890", host,
                         "www.serenedb.org");
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]", host, "127.0.0.1");
  CHECK_ENDPOINT_FEATURE(client, "ssl://[::]", host, "::");
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]:7890", host, "127.0.0.1");
  CHECK_ENDPOINT_FEATURE(client, "ssl://[::]:7890", host, "::");
  CHECK_ENDPOINT_FEATURE(client,
  ...
  CHECK_ENDPOINT_FEATURE(client,
                         "ssl://[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890",
                         host, "2001:0db8:0000:0000:0000:ff00:0042:8329");
  CHECK_ENDPOINT_FEATURE(client, "http@ssl://[::]:7890", host, "::");
...
TEST(EndpointTest, EndpointHostString) {
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://DE.triagens.SereneDB.org", hostAndPort,
                         "de.triagens.serenedb.org:7890");
  CHECK_ENDPOINT_FEATURE(client, "tcp://192.168.173.13:7890", hostAndPort,
                         "192.168.173.13:7890");
  CHECK_ENDPOINT_FEATURE(client, "tcp://192.168.173.13:678", hostAndPort,
                         "192.168.173.13:678");
  CHECK_ENDPOINT_FEATURE(client, "tcp://127.0.0.1:7890", hostAndPort,
                         "127.0.0.1:7890");
  CHECK_ENDPOINT_FEATURE(client, "tcp://127.0.0.1:44", hostAndPort,
                         "127.0.0.1:44");
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost:7890", hostAndPort,
                         "127.0.0.1:7890");
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost:65535", hostAndPort,
                         "127.0.0.1:65535");
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.serenedb.org:7890", hostAndPort,
                         "www.serenedb.org:7890");
  CHECK_ENDPOINT_FEATURE(client, "tcp://serenedb.org:7890", hostAndPort,
                         "serenedb.org:7890");
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]", hostAndPort,
                         "[127.0.0.1]:7890");
  CHECK_ENDPOINT_FEATURE(client, "tcp://[::]", hostAndPort, "[::]:7890");
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]:7890", hostAndPort,
                         "[127.0.0.1]:7890");
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]:65535", hostAndPort,
                         "[127.0.0.1]:65535");
  CHECK_ENDPOINT_FEATURE(client, "tcp://[::]:7890", hostAndPort, "[::]:7890");
  ...
  CHECK_ENDPOINT_FEATURE(
    ...
    "[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890");
  CHECK_ENDPOINT_FEATURE(
    client, "tcp://[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890", hostAndPort,
    "[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890");
  CHECK_ENDPOINT_FEATURE(
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://DE.triagens.SereneDB.org", hostAndPort,
                         "de.triagens.serenedb.org:7890");
  CHECK_ENDPOINT_FEATURE(client, "ssl://192.168.173.13:7890", hostAndPort,
                         "192.168.173.13:7890");
  CHECK_ENDPOINT_FEATURE(client, "ssl://192.168.173.13:1234", hostAndPort,
                         "192.168.173.13:1234");
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost:7890", hostAndPort,
                         "127.0.0.1:7890");
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost:5", hostAndPort,
                         "127.0.0.1:5");
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.serenedb.org:7890", hostAndPort,
                         "www.serenedb.org:7890");
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.serenedb.org:12345", hostAndPort,
                         "www.serenedb.org:12345");
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]", hostAndPort,
                         "[127.0.0.1]:7890");
  CHECK_ENDPOINT_FEATURE(client, "ssl://[::]", hostAndPort, "[::]:7890");
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]:7890", hostAndPort,
                         "[127.0.0.1]:7890");
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]:32768", hostAndPort,
                         "[127.0.0.1]:32768");
  CHECK_ENDPOINT_FEATURE(client, "ssl://[::]:7890", hostAndPort, "[::]:7890");
  CHECK_ENDPOINT_FEATURE(
    client, "ssl://[2001:0db8:0000:0000:0000:ff00:0042:8329]", hostAndPort,
    "[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890");
  CHECK_ENDPOINT_FEATURE(
    client, "ssl://[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890", hostAndPort,
    "[2001:0db8:0000:0000:0000:ff00:0042:8329]:7890");
  CHECK_ENDPOINT_FEATURE(
...
TEST(EndpointTest, EndpointClientTcpIpv6WithoutPort) {
  ...
  EXPECT_TRUE("http+tcp://[::]:7890" == e->specification());
  EXPECT_TRUE(sdb::Endpoint::EndpointType::Client == e->type());
  EXPECT_TRUE(sdb::Endpoint::DomainType::IPv6 == e->domainType());
  EXPECT_TRUE(sdb::Endpoint::EncryptionType::None == e->encryption());
  EXPECT_TRUE(AF_INET6 == e->domain());
  EXPECT_TRUE("::" == e->host());
  EXPECT_TRUE(7890 == e->port());
  EXPECT_TRUE("[::]:7890" == e->hostAndPort());
  EXPECT_TRUE(false == e->isConnected());
}
