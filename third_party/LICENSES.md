...
* [SQLite](https://www.sqlite.org), [public domain](https://www.sqlite.org/copyright.html) (the 3.53.4 amalgamation, reached through PROJ's embedded `proj.db`). The submodule tracks
