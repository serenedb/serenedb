...
/// have epsilon-arcs leaving them, have no non-epsilon arcs leaving them.  It
/// does this by creating extra states and adding extra epsilon transitions.  An
/// epsilon arc is defined as an arc where both the ilabel and the olabel are
/// epsilons. This function may fail with KALDI_ASSERT for certain cyclic FSTs,
/// but is safe in the acyclic case.
template<class Arc>
