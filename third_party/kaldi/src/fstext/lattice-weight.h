...
class CompactLatticeWeightTpl {
 public:
  ...
  CompactLatticeWeightTpl(
    const CompactLatticeWeightTpl& compactLatticeWeightTpl) = default;

  CompactLatticeWeightTpl& operator=(const CompactLatticeWeightTpl& w) =
    default;
...
inline CompactLatticeWeightTpl<WeightType, IntType> Divide(
  ...
  if (div == DIVIDE_LEFT) {
    ...
    return CompactLatticeWeightTpl<WeightType, IntType>(
      w,
      std::vector<IntType>(v1b + (v2e - v2b), v1e));  // return last part of v1.
    ...
    return CompactLatticeWeightTpl<WeightType, IntType>(
      w, std::vector<IntType>(v1b,
                              v1e - (v2e - v2b)));  // return first part of v1.
